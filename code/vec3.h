...
class vec3 {
    ...
    public:
        // Array of floats that contains 
        // --------------------------------------------------------------------------------
        float e[3];

        // <- This line should not be neccecarry, I think?
        //vec3(){}
        ...
        // --------------------------------------------------------------------------------
        inline const vec3& operator+(const vec3 &v1, const vec3 &v2) {return vec3(v1.e[0] + v2.e[0], v1.e[1] + v2.e[1], v1.e[2] + v2.e[2]);}
        ...
        // Calculates the length of the vector, but without the heavy ass square root
        // operation. 
        // --------------------------------------------------------------------------------
        inline float squared_length() const {return e[0]*e[0] + e[1]*e[1] + e[2]*e[2];}

        // heavy ass square root operation.
        // --------------------------------------------------------------------------------
